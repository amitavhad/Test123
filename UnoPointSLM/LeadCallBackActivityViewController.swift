//
//  LeadCallBackActivityViewController.swift
//  UnoPointSLM
//
...
class LeadCallBackActivityViewController: UIViewController ,CLLocationManagerDelegate{
    ...
    func CallBackctivitysubmit(){
        
        //    let parameters = ""
        //
        var  m_strStatus = "CallBack";
        let parameters="imei="+m_strenggimeino!+"&ver="+m_strappversion!+"&lat="+m_strlat+"&lon="+m_strlon+"&Date="+m_strDate+"&Time="+m_strTime+"&StatusName="+m_strStatus+"&Remarks="+txtRemarks.text!+"&Lead_ID="+leadid
