//
//  MeetStartActivityViewController.swift
//  UnoPointSLM
//
//  Created by Amit A on 12/12/18.
...
class MeetStartActivityViewController: UIViewController,CLLocationManagerDelegate {
...
//        let  m_strStatus = "CallBack";
        let parameters="imei="+m_strenggimeino!+"&ver="+m_strappversion!+"&action=MobileDevice"+"&lat="+m_strlat+"&lon="+m_strlon+"&message="+m_strMessage+"&comment="+txtRemarks.text!
...
//self.lblserverreply.text = "Server Reply: Schedule Updated Successfully
